...
export default function EventDetail() {
    ...
    const handleJoin = async (e) => {
        ...
        // Cek sekali lagi di sisi client (UX yang bagus)
        if (isRegistered) {
            alert("Kamu sudah terdaftar di undian ini!");
            return;
        }
        ...
        try {
            ...
            alert("Berhasil Daftar! Semoga beruntung!");
            setGameUsername(''); // Kosongkan input
        } catch (error) {
